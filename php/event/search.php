        ...
        <div class="panel panel-default">
         <div class="panel-body">
          ...
          <div class="event-list">
            <div class="row">
          <?php 
          $events = search_events_recent_after_today_union_norm($_GET['search_event'],$_GET['search_event'],$_GET['search_event']);
          //print_r($events);
            foreach($events as $event){
              ...
              ?>
                ...
                <div class="row event">
                 <!--<div class="thumbnail">-->
                    <div class="caption">
                      <div id="event-header"><h3><a class="event-title" href="index.php?event_id=<?php echo $event['id']?>"><?php echo $event['event_name']?></a></h3>
                        ...
                        ?>
                        <a class="event-info-text pull-right like-btn" style="color:#AAA; display:inline-block; cursor:pointer;" href="like.php?event_id=<?php echo $event['id']?>&user_id=<?php echo $user?>">Like?(<?php echo $event['event_likes']?>)</a>
                      ...
                      if (strlen($string) > 500) {
                          ...
                          $string = substr($stringCut, 0, strrpos($stringCut, ' ')).'... <a href="index.php?event_id='.$event['id'].'">Read More</a>'; 
                      }
                      echo $string;
